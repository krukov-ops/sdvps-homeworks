# Домашнее задание к занятию "`Docker. Часть 2`" - `Крюков Николай`
...
`docker compose гораздо удобнее shell-скриптов, позволяя собирать множества разных контейнеров,  создавая между ними зависимости и связи`
